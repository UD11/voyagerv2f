...
const Footer = () => {
  return (
    <footer className="bg-gray-200 py-8 text-gray-600 text-center rounded-3xl ">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center">
          ...
          {/* Contact information */}
          <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-4">
            <p className="text-base sm:text-lg font-semibold mb-2">Contact us:</p>
            <p className="text-sm sm:text-base">mail-UD: <a href="mailto:sealuddalak84@gmail.com" className="text-blue-500 hover:text-blue-700">sealuddalak84@gmail.com </a></p>
            <p className="text-sm sm:text-base">mail-AB: <a href="mailto:sarkar.ab07@gmail.com" className="text-blue-500 hover:text-blue-700">sarkar.ab07@gmail.com</a></p>
          </div>

          {/* Additional links or sections */}
          <div className="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-4">
            <p className="text-base sm:text-lg font-semibold mb-2">Explore Voyager:</p>
