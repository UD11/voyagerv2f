...
const CardList = () => {
  ...
  const [upvotePdf, { loading: upvoteLoading, error: upvoteError }] = useMutation(
    UPVOTE_QUERY
  );
  const [downvotePdf, { loading: downvoteLoading, error: downvoteError }] = useMutation(
    DOWNVOTE_QUERY
  );
...
const ProfilePage = () => {
  ...
  const [user, setUser] = useState({
    ...
    avatar: "/path-to-profile-avatar.jpg",
  });
  ...
  return (
    <div className="bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        {user ? (
          <div>
            <div className="bg-white rounded-full py-2 shadow-md mb-8 flex items-center justify-between px-12">
                <Logo />
              <div className="flex items-center justify-center">
                ...
                <img
                  src={user.avatar}
                  alt="Profile Avatar"
                  className="w-20 h-20 rounded-full object-cover mr-4 border border-cyan-300"
                />
                <div>
            ...
            <div className="bg-white rounded-3xl p-4 shadow-md shadow-cyan-500">
              <h1 className="text-3xl font-semibold mb-4 p-4 flex items-center justify-center">My Articles</h1>
              <CardList />
            </div>
            <button
              onClick={logout}
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">
              Please sign up or sign in to view your profile and articles.
            </p>
            <button
              onClick={login}
